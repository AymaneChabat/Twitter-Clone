...
async function createChats(token, user) {
    try {
        ...
        const response = await fetch("http://xclone-api-git-master-aymanechabat.vercel.app1/api/chat", {
            method: "POST",
            headers: {
...
async function getChats(token, last) {
    try {
        ...
        const response = await fetch("http://xclone-api-git-master-aymanechabat.vercel.app/api/chats", {
            method: "POST",
            headers: {
                'Content-Type': 'application/json',
                'Authorization': token
...
async function sendMessage(token, message) {
    try {
        ...
        const response = await fetch("http://xclone-api-git-master-aymanechabat.vercel.app/api/message", {
            method: "POST",
            headers: {
                'Content-Type': 'application/json',
                'Authorization': token
...
async function retrieveMessages(token, chatId) {
    try {
        ...
        const response = await fetch("http://xclone-api-git-master-aymanechabat.vercel.app/api/message?chat=" + chatId, {
            method: "GET",
            headers: {
                'Content-Type': 'application/json',
                'Authorization': token
...
async function checkChat(token, participant) {
    try {
        ...
        const response = await fetch("http://xclone-api-git-master-aymanechabat.vercel.app/api/chat?participant=" + participant, {
            headers: {
                'Authorization': token
            }
        });
