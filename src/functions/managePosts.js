...
async function addPost(data, token) {
    try {
        ...
        const response = await fetch("http://xclone-api-git-master-aymanechabat.vercel.app/api/post", {
            method: "POST",
            headers: {
                'Authorization': token
            },
...
async function getPosts(post, tab, last, username, token) {
    try {
        ...
        const url = "http://xclone-api-git-master-aymanechabat.vercel.app/api/post?tab=" + tab +
...
async function updatePost(token, postId) {
    try {
        ...
        const response = await fetch("http://xclone-api-git-master-aymanechabat.vercel.app/api/post/" + postId, {
            method: "PUT",
            headers: {
                'Content-Type': 'application/json',
                'Authorization': token
...
async function postReply(data, token, post, username) {
    try {
        ...
        const response = await fetch("http://xclone-api-git-master-aymanechabat.vercel.app/api/" + username + "/post/" + post, {
            method: "POST",
            headers: {
                'Authorization': token
            },
...
async function getReplies(token, post, username) {
    try {
        ...
        const response = await fetch("http://xclone-api-git-master-aymanechabat.vercel.app/api/" + username + "/replies/" + post, {
            method: "GET",
            headers: {
                'Authorization': token
            }
