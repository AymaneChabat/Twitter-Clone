...
export function BellIcon({picked}) {
    return (
      <svg className="dark:stroke-[#ffffff] stroke-[#000000]" wwidth="26" height="26" viewBox="0 0 23 25" fill="none">
        <g id="SVGRepo_bgCarrier" stroke-width="2" />
          ...
          <g id="Communication / Bell" className="dark:fill-[#ffffff]" fill={picked[0] === picked[1] ? "#000000" : 'none'}> 
...
export function ListIcon({picked}) {
    return (
        <svg className="dark:fill-[#ffffff]" viewBox="0 0 24 24" aria-hidden="true" width={26} height={26}>
            <g>
...
export function MessageIcon({picked}) {
    return (
        <svg className="dark:fill-[#ffffff]" viewBox="0 0 24 24" aria-hidden="true" width="26" height="26">
            <g>
                <path d={picked[1] === picked[0] ? "M1.998 4.499c0-.828.671-1.499 1.5-1.499h17c.828 0 1.5.671 1.5 1.499v2.858l-10 4.545-10-4.547V4.499zm0 5.053V19.5c0 .828.671 1.5 1.5 1.5h17c.828 0 1.5-.672 1.5-1.5V9.554l-10 4.545-10-4.547z" : "M1.998 5.5c0-1.381 1.119-2.5 2.5-2.5h15c1.381 0 2.5 1.119 2.5 2.5v13c0 1.381-1.119 2.5-2.5 2.5h-15c-1.381 0-2.5-1.119-2.5-2.5v-13zm2.5-.5c-.276 0-.5.224-.5.5v2.764l8 3.638 8-3.636V5.5c0-.276-.224-.5-.5-.5h-15zm15.5 5.463l-8 3.636-8-3.638V18.5c0 .276.224.5.5.5h15c.276 0 .5-.224.5-.5v-8.037z"}></path>
            </g>
        </svg>
    )
}
...
export function ProfileIcon({picked}) {
    return (
        <svg className="dark:fill-[#ffffff]" viewBox="0 0 24 24" aria-hidden="true" width={26} height={26}>
            <g>
                <path d={picked[1] === picked[0] ? "M17.863 13.44c1.477 1.58 2.366 3.8 2.632 6.46l.11 1.1H3.395l.11-1.1c.266-2.66 1.155-4.88 2.632-6.46C7.627 11.85 9.648 11 12 11s4.373.85 5.863 2.44zM12 2C9.791 2 8 3.79 8 6s1.791 4 4 4 4-1.79 4-4-1.791-4-4-4z" : "M5.651 19h12.698c-.337-1.8-1.023-3.21-1.945-4.19C15.318 13.65 13.838 13 12 13s-3.317.65-4.404 1.81c-.922.98-1.608 2.39-1.945 4.19zm.486-5.56C7.627 11.85 9.648 11 12 11s4.373.85 5.863 2.44c1.477 1.58 2.366 3.8 2.632 6.46l.11 1.1H3.395l.11-1.1c.266-2.66 1.155-4.88 2.632-6.46zM12 4c-1.105 0-2 .9-2 2s.895 2 2 2 2-.9 2-2-.895-2-2-2zM8 6c0-2.21 1.791-4 4-4s4 1.79 4 4-1.791 4-4 4-4-1.79-4-4z"}></path>
            </g>
        </svg>
    )
}

export function SearchIcon({picked, color, size}) {
    return (
        <svg width={size} height={size} viewBox="0 0 24.00 24.00" fill="none">
            <g stroke-width="0"/>
            <g stroke-linecap="round" stroke-linejoin="round"/>
            <g> 
                <path d="M15.7955 15.8111L21 21M18 10.5C18 14.6421 14.6421 18 10.5 18C6.35786 18 3 14.6421 3 10.5C3 6.35786 6.35786 3 10.5 3C14.6421 3 18 6.35786 18 10.5Z" className="dark:stroke-[#ffffff]" stroke={color} stroke-width={picked[0] === picked[1] ? "3.5" : "2.276"} stroke-linecap="round" stroke-linejoin="round"/> 
            </g>
        </svg>
    )
}
