...
export function BellIcon({picked}) {
    return (
      <svg className="dark:stroke-[#ffffff]" wwidth="26" height="26" viewBox="0 0 23 25" fill="none">
...
export function BookmarkIcon({picked}) {
    return (
        <svg width="26" height="26" viewBox="0 0 23 23" className="dark:fill-[#ffffff]" fill={picked[0] === picked[1] ? "#000000" : "none"}>
            <g stroke-width="0"/>
...
export function MoreIcon({picked}) {
    return (
        <svg className="dark:fill-[#ffffff]" viewBox="0 0 24 24" aria-hidden="true" width={26} height={26}>
            <g>
...
export function PostIcon({data, picked}) {
    return (
