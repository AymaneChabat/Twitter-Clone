function LoadingIcon({w}) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className="m-auto bg-none block" width="60px" height="60px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
