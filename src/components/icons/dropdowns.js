export function Mentions({color}) {
    return (
        <svg className="dark:stroke-[#ffffff] " viewBox="0 0 24 24" aria-hidden="true" width="16" height="16" fill={color === undefined ? "#ffffff" : color}>
            <g>
...
export function CheckMark({color}) {
    return (
        <svg viewBox="0 0 24 24" aria-hidden="true" width="22" height="22" className={"dark:stroke-[#ffffff] fill-["+(color ? color : "#1d9bf0") + "]"}>
            <g>
...
export function EarthIcon({color}) {
    return (
        <svg className="dark:stroke-[#ffffff] " viewBox="0 0 24 24" aria-hidden="true" width="16" height="16" fill={color === undefined ? "#ffffff" : color}>
            <g>
