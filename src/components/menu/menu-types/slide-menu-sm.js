...
function SlideMenu({opened,setOpened}) {
  return (
    <div className={opened ? 'absolute h-full w-full bg-[#000000]/[.4] transition-all transition-300' : 'absolute h-full w-full bg-[#000000]/[.4] transition-all transition-300 -translate-x-full'} onClick={()=>{setOpened(false)}}>
