  ...
  return (
    <>
      {postOpen ? (
        <div
          className={
            "absolute w-full  h-full s7:bg-[#000000]/[.4] z-50 s7:pt-[50px] bg-[#ffffff] " +
            bg()
          }
          onMouseDown={() => {
            setPostOpen(false);
        ...
        >
          ...
          <div
            className={
              "w-100% s7:w-[650px] rounded-lg border border-[#ffffff]/[.1] mx-auto " +
              bg()
            }
      ...
      {w < 600 && page === "home" ? (
        <div
          className="fixed right-4 bottom-[70px] z-20"
          onClick={() => {
            setPostOpen(true);
          }}
        >
